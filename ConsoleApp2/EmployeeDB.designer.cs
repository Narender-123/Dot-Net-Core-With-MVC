...
namespace ConsoleApp2
{
    ...
    partial void InsertEmployee3(Employee3 instance);
    partial void UpdateEmployee3(Employee3 instance);
    partial void DeleteEmployee3(Employee3 instance);
    #endregion
		
		public EmployeeDBDataContext() : 
				base(global::ConsoleApp2.Properties.Settings.Default.LinqDemoConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<Employee3> Employee3s
		{
			get
			{
				return this.GetTable<Employee3>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Employees2")]
	public partial class Employee3 : INotifyPropertyChanging, INotifyPropertyChanged
	{
